...
import com.example.submission1_intermediate.databinding.ActivityPostBinding
...
class PostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.uploadButton.setOnClickListener {
            ...
            when{
                foto==null ->{
                    Toast.makeText(this@PostActivity, "Silakan masukkan foto.", Toast.LENGTH_SHORT).show()
                }
                desc.isEmpty()->{
                    Toast.makeText(this@PostActivity, "Silakan masukkan deskripsi.", Toast.LENGTH_SHORT).show()
                }
    ...
    private fun startTakePhoto() {
        ...
        createCustomTempFile(application).also {
            val photoURI: Uri = FileProvider.getUriForFile(
                this@PostActivity,
                "com.example.submission1_intermediate",
                it
            )
